...
with col1:
    st.markdown(
        ...
        <a href="https://teachers.streamlit.app/vision(new)" target="_blank" style="text-decoration: none;">
...
with col2:
    st.markdown(
        ...
        <a href="https://teachers.streamlit.app/text_gen(new)" target="_blank" style="text-decoration: none;">
...
with col1:
    st.markdown(
        ...
        <a href="https://teachers.streamlit.app/image_gen" target="_blank" style="text-decoration: none;">
            <span style="font-size: 100px;">🖌️</span>
            <div style="text-align: center; font-size: 20px;">클릭하세요</div>
        </a>
